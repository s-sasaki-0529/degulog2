# デグーの初期データを作成
Degu.create(name: 'パズー', gender: 'male',  birthday: '2015/12/01', come_date: '2016/03/20')
Degu.create(name: 'メイ',   gender: 'female', birthday: '2016/02/01', come_date: '2016/05/07')
Degu.create(name: 'ジジ',   gender: 'male',  birthday: '2016/09/01', come_date: '2017/05/03')
Degu.create(name: 'キキ',   gender: 'female', birthday: '2016/02/01', come_date: '2017/05/03', died_date: '2017/06/13')
Degu.create(name: 'ハク',   gender: 'male',  birthday: '2017/06/01', come_date: '2017/07/09')
Degu.create(name: 'セン',   gender: 'female', birthday: '2017/06/01', come_date: '2017/07/09')
Degu.create(name: 'チヒロ', gender: 'female', birthday: '2017/06/01', come_date: '2017/07/09')
Degu.create(name: 'ハル',   gender: 'unknown', birthday: '2017/08/07', come_date: '2017/08/07')
Degu.create(name: 'バロン', gender: 'unknown', birthday: '2017/08/07', come_date: '2017/08/07')
Degu.create(name: 'ムタ',   gender: 'unknown', birthday: '2017/08/07', come_date: '2017/08/07')
Degu.create(name: 'ルーン', gender: 'unknown', birthday: '2017/08/07', come_date: '2017/08/07')
Degu.create(name: 'ユキ',   gender: 'unknown', birthday: '2017/08/07', come_date: '2017/08/07')
Degu.create(name: 'トト',   gender: 'unknown', birthday: '2017/08/07', come_date: '2017/08/07')
Degu.create(name: 'ナトル', gender: 'unknown', birthday: '2017/08/07', come_date: '2017/08/07')
